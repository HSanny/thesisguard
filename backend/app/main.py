...
app = FastAPI(title="ThesisGuard", version="0.3.5")
...
def health() -> dict:
    ...
    return {"ok": True, "service": "thesisguard-api", "version": "0.3.5", "workers": services}
...
def dashboard() -> str:
    return r"""
<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>ThesisGuard v0.3.5</title>
<style>
...
<div class='top'><div><h1 style='margin-bottom:4px'>ThesisGuard <span class='pill'>v0.3.5 GROUP-QUERY</span></h1><div class='muted'>Interactive event-driven market intelligence · ask the bot about market, events and portfolio impact</div></div><div id='health' class='muted'>checking worker…</div></div>
