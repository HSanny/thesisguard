...
app = FastAPI(title="ThesisGuard", version="0.2.0")
...
def health() -> dict:
    ...
    return {"ok": True, "service": "thesisguard-api", "version": "0.2.0", "workers": services}
...
def dashboard() -> str:
    return r"""
<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>ThesisGuard v0.2</title>
<style>
...
<div class='top'><div><h1 style='margin-bottom:4px'>ThesisGuard <span class='pill'>v0.2 LIVE</span></h1><div class='muted'>Thesis-aware market monitoring · Binance WS primary + REST validation</div></div><div id='health' class='muted'>checking worker…</div></div>
