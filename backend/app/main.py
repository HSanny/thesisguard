...
def health() -> dict:
    ...
    return {"ok": True, "service": "thesisguard-api", "version": "0.3.1", "workers": services}
...
def dashboard() -> str:
    return r"""
<!doctype html><html><head><meta charset='utf-8'><meta name='viewport' content='width=device-width,initial-scale=1'><title>ThesisGuard v0.3.1</title>
<style>
